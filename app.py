# app.py - VibeNet  (SQLAlchemy ORM  |  pg8000 driver  |  Supabase PostgreSQL  |  Supabase Storage)
import os
import uuid
import datetime
...
# Set SUPABASE_DB_URL in Render dashboard → Environment
...
# Force pg8000 driver (pure Python, works on any Python version including 3.14)
